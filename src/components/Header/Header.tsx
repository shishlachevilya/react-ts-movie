    ...
    <div>
      <nav className="navbar navbar-dark bg-info">
        ...
        <div>
          ...
          <Link to="/library" className="badge badge-danger">
            my library
          </Link>
        </div>
      </nav>
